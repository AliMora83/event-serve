...
const Hero = () => {
  return (
    <section className="bg-[#2a1818] text-gray-100 py-20">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <button className="bg-white text-[#2a1818] px-8 py-3 rounded-lg font-semibold hover:bg-gray-200 transition-colors">
          Get Started
        </button>
      </div>
    </section>
